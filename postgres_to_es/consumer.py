...
from index import CINEMA_INDEX_BODY as esbody
from models import ESMovie, ESPerson, ETLFilmWork
from decorator import coroutine, some_sleep
from elastic import ETLElastic
...
class ETLConsumer:
    ...
    def put_films_to_ES(self) -> bool:
        while True:
            ...
            esfilms = [
                ESMovie(
                    film.id, film.rating, film.imdb_tconst, film.genres,
